        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "text", nullable: false, defaultValue: BoardType.Public),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoardInvites_AspNetUsers_InviteeId",
                        column: x => x.InviteeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardInvites_AspNetUsers_InviterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "text", nullable: false, defaultValue: "file"),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_BoardInvites_InviteId",
                        column: x => x.InviteId,
                        principalTable: "BoardInvites",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardInvites_InviteeId",
                table: "BoardInvites",
                column: "InviteeId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardInvites_InviterId",
                table: "BoardInvites",
                column: "InviterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_InviteId",
                table: "Notifications",
                column: "InviteId");
